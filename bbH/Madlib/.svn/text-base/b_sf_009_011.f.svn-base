      SUBROUTINE SB_SF_009_011(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_009_011(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_009_011(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/            1/                                       
      DATA (CF(i,1  ),i=1  ,2  ) /    -8,    1/                            
C               T[ 4, 5, 1, 2]                                             
      DATA Denom(2  )/            1/                                       
      DATA (CF(i,2  ),i=1  ,2  ) /     1,    1/                            
C               T[ 4, 5, 2, 1]                                             
C ----------
C BEGIN CODE
C ----------
     ...
     &     11  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_009_011 =B_SF_009_011+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
