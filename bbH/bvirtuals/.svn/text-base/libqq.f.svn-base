...
c dvirt is already included in matv_qq
      dirfinite=0d0*dvirt+ceps1s*(lmu-GammaE)+
     $     ceps2*(lmu**2/2d0-gammaE*lmu+gammaE**2/2d0+pi**2/12d0)
c      matv_qq=matv_qq+2d0*sig0qq*dirfinite
c POWHEG convention:
      lt=dlog(muedr**2/mt**2)
      ceps1=ceps2*lt+ceps1s
      mirpole_1=2d0*sig0qq*ceps1
      dirfinite=ceps1s*lt+
     $     ceps2*(lt**2+pi**2/3d0)/2d0
...
************************************************************************
        function C0_(q01,q12,q20,m0,m1,m2)                            
************************************************************************
...
************************************************************************
        FUNCTION D0_(P1,P2,P3,P4,P12,P23,M1,M2,M3,M4) 
************************************************************************
...
************************************************************************
	...
	COMPLEX*16 S0(4),XX0(2),X0(2,4), R(4,4),G(2)
        COMPLEX*16 D0_,CSPENS,ETA,SQE,ETAS
...
c      c1(0) = dreal(cscal(q3,0d0,m1,m3,m2))
      c1(0)=dreal(C0_(q1,q2,q3,m1,m2,m3))
      goto 100
 240  qq2 = q2
      qq1 = q1
      qq3 = q3
...
c 300  c1(0) = c0(qq1,qq2,qq3,mm1,mm2,mm3)
 300  c1(0)=dreal(C0_(qq1,qq2,qq3,mm1,mm2,mm3))
      goto 100
